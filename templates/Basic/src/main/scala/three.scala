...
class BufferGeometry extends js.Object {
  ...
  var drawcalls: js.Array[js.Any] = ???
  var offsets: js.Array[js.Any] = ???
...
class AreaLight protected () extends Light {
...
class XHRLoader protected () extends js.Object {
  def this(manager: LoadingManager = ???) = this()
...
class MeshFaceMaterial protected () extends Material {
...
class PointCloudMaterial protected () extends Material {
...
class RawShaderMaterial protected () extends ShaderMaterial {
...
class SpriteCanvasMaterial protected () extends Material {
...
class Matrix3 extends Matrix {
  ...
  //override var elements: Float32Array = ???
...
class Matrix4 protected () extends Matrix {
...
@JSName("THREE.Spline")
class Spline protected () extends js.Object {
...
@JSName("THREE.Bone")
class Bone protected () extends Object3D {
...
class MorphAnimMesh protected () extends Mesh {
...
class PointCloud protected () extends Object3D {
...
class CanvasRenderer protected () extends Renderer {
...
class WebGLRenderTarget protected () extends RenderTarget {
...
//  override var mipmaps: js.Array[ImageData] = ???
...
class KeyFrameAnimation protected () extends js.Object {
...
class MorphAnimation protected () extends js.Object {
...
@JSName("THREE.Path")
class Path protected () extends CurvePath {
...
class ClosedSplineCurve3 protected () extends Curve {
...
class CubicBezierCurve protected () extends Curve {
...
class CubicBezierCurve3 protected () extends Curve {
...
class EllipseCurve protected () extends Curve {
...
class LineCurve protected () extends Curve {
...
class LineCurve3 protected () extends Curve {
...
class QuadraticBezierCurve protected () extends Curve {
...
class QuadraticBezierCurve3 protected () extends Curve {
...
class SplineCurve protected () extends Curve {
  def this(points: js.Array[Vector2] = ???) = this()
...
class SplineCurve3 protected () extends Curve {
  def this(points: js.Array[Vector3] = ???) = this()
  var points: js.Array[Vector3] = ???
  override def getPoint(t: Double): Vector3 = ???
}
...
class IcosahedronGeometry protected () extends PolyhedronGeometry {
...
class AxisHelper protected () extends Line {
...
class EdgesHelper protected () extends Line {
  def this(`object`: Object3D, hex: Double = ???) = this()
}

@JSName("THREE.FaceNormalsHelper")
class FaceNormalsHelper protected () extends Line {
...
class GridHelper protected () extends Line {
...
class SkeletonHelper protected () extends Line {
...
class VertexTangentsHelper protected () extends Line {
  def this(`object`: Object3D, size: Double = ???, hex: Double = ???, linewidth: Double = ???) = this()
  var `object`: Object3D = ???
  var size: Double = ???
  def update(`object`: Object3D = ???): Unit = ???
...
class WireframeHelper protected () extends Line {
  def this(`object`: Object3D, hex: Double = ???) = this()
}
...
//
//@JSName("THREE")
//package @JSName("THREE.ShaderFlares")
